  ...
  return (
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <span className="text-sm text-gray-400">총 {indices.length}개 지수</span>
        <div className="flex items-center gap-2 text-xs text-gray-500">
          {lastUpdated && <span>업데이트: {lastUpdated}</span>}
          <button onClick={fetchIndices} className="rounded-lg p-1.5 hover:bg-gray-800 text-gray-400 hover:text-white transition-colors">
